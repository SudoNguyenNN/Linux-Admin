...
Miêu Tả: **poidof** tìm quá trình id's (pids) trong những chương trình được đặt tên.Nó in ra những cái ID trên đầu ra tiêu chuẩn.Chương trình này trên một số hệ thống sử dụng run-level thay đổi scripts
